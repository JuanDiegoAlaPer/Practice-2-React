...
function App() {
  useEffect(() => {
    ...
    const toggleMenu = () => {
      ...
      menuToggle.innerHTML = menuList.classList.contains("active")
        ? "&times;"
        : "&#9776;";
    };
    ...
    <div className="container">
      <div className="menu">
        ...
        <div className="avatar-container" id="avatar-container">
          <img src={avatarImage} className="avatar" alt="avatarImage" />
        </div>
      </div>
      <div className="content">
        ...
        <div className="options" id="options">
          ...
          <div className="option" id="option2">
            ...
            <div className="option2-back"></div>
            <div className="option2-top"></div>
            <div className="option2-bottom"></div>
            <div className="option2-left"></div>
            <div className="option2-right"></div>
          </div>

          <div className="option" id="option3">
            <div className="option3-front">
            ...
            <div className="option3-back"></div>
            <div className="option3-top"></div>
            <div className="option3-bottom"></div>
            <div className="option3-left"></div>
            <div className="option3-right"></div>
          </div>
        </div>
      </div>
